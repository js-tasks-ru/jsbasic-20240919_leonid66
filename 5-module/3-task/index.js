  ...
  // ваш код...
    ...
    <div class="container" data-carousel-holder>
      <div class="carousel">
        ...
        <div class="carousel__inner">      //* soderjimoe *//
          ...
          <div class="carousel__slide" data-id="chicken-springrolls">
            ...
            <div class="carousel__caption"><span class="carousel__price">€6.50</span>
              <div class="carousel__title">Chicken springrolls</div>
                <button type="button" class="carousel__button"><img src="/assets/images/icons/plus-icon.svg" alt="icon"></button>
            </div>
          </div>
